...
#include "ActsExamples/Io/Root/RootCEPCMeasurementReader.hpp"
...
int main(int argc, char* argv[]) {
  ...
  RootCEPCMeasurementReader::Config CEPCMeasurementReaderCfg;
  CEPCMeasurementReaderCfg.filePath = inputDir + "/" + inputfiles.front();
  CEPCMeasurementReaderCfg.outputSimHits = "hits";
  CEPCMeasurementReaderCfg.outputParticles = "particles";
  CEPCMeasurementReaderCfg.trackingGeometry = trackingGeometry;
  CEPCMeasurementReaderCfg.randomNumbers = rnd;
  sequencer.addReader(std::make_shared<RootCEPCMeasurementReader>(
      CEPCMeasurementReaderCfg, logLevel));
  ...
  particleSelectorCfg.inputParticles = CEPCMeasurementReaderCfg.outputParticles;
  particleSelectorCfg.inputMeasurementParticlesMap =
      CEPCMeasurementReaderCfg.outputMeasurementParticlesMap;
  ...
  trackFinderCfg.inputMeasurementSimHitsMap =
      CEPCMeasurementReaderCfg.outputMeasurementSimHitsMap;
  trackFinderCfg.inputSimulatedHits = CEPCMeasurementReaderCfg.outputSimHits;
  ...
  if(truthEstimatedSeeded)
  {
    ...
    spCfg.inputSourceLinks = CEPCMeasurementReaderCfg.outputSourceLinks;
    spCfg.inputMeasurements = CEPCMeasurementReaderCfg.outputMeasurements;
    ...
    paramsEstimationCfg.inputSourceLinks =
        CEPCMeasurementReaderCfg.outputSourceLinks;
  ...
  sorterCfg.inputSimulatedHits = CEPCMeasurementReaderCfg.outputSimHits;
  sorterCfg.inputMeasurementSimHitsMap = CEPCMeasurementReaderCfg.outputMeasurementSimHitsMap;
  ...
  fitter.inputMeasurements = CEPCMeasurementReaderCfg.outputMeasurements;
  fitter.inputSourceLinks = CEPCMeasurementReaderCfg.outputSourceLinks;
  ...
  trackStatesWriter.inputSimHits = CEPCMeasurementReaderCfg.outputSimHits;
