...
/// @brief TGeoCEPCVXDLayerSplitter
///
/// Split Cylinder and disks into submodules
class TGeoCEPCVXDLayerSplitter : public ITGeoDetectorElementSplitter {
 public:
  ...
  TGeoCEPCVXDLayerSplitter(const Config& cfg,
                          std::unique_ptr<const Acts::Logger> logger =
                              Acts::getDefaultLogger("TGeoCEPCVXDLayerSplitter",
                                                     Acts::Logging::INFO));

  virtual ~TGeoCEPCVXDLayerSplitter() = default;
