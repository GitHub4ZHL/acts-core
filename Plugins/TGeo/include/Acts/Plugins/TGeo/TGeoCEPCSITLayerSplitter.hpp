...
/// @brief TGeoCEPCSITLayerSplitter
///
/// Split Cylinder and disks into submodules
class TGeoCEPCSITLayerSplitter : public ITGeoDetectorElementSplitter {
 public:
  ...
  TGeoCEPCSITLayerSplitter(const Config& cfg,
                          std::unique_ptr<const Acts::Logger> logger =
                              Acts::getDefaultLogger("TGeoCEPCSITLayerSplitter",
                                                     Acts::Logging::INFO));

  virtual ~TGeoCEPCSITLayerSplitter() = default;
