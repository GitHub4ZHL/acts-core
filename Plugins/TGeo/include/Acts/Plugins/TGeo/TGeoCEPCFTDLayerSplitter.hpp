...
/// @brief TGeoCEPCFTDLayerSplitter
///
/// Split Cylinder and disks into submodules
class TGeoCEPCFTDLayerSplitter : public ITGeoDetectorElementSplitter {
 public:
  ...
  TGeoCEPCFTDLayerSplitter(const Config& cfg,
                          std::unique_ptr<const Acts::Logger> logger =
                              Acts::getDefaultLogger("TGeoCEPCFTDLayerSplitter",
                                                     Acts::Logging::INFO));

  virtual ~TGeoCEPCFTDLayerSplitter() = default;
