...
if stddev_p == 0:
    ...
    outputDir = Path.cwd() / "wt_pos_stddev_1"
elif stddev_p == 2:
    outputDir = Path.cwd() / "wt_pos_stddev_2"
elif stddev_p == 3:
    outputDir = Path.cwd() / "wt_pos_stddev_3"
elif stddev_p == 4:
    outputDir = Path.cwd() / "wt_pos_stddev_4"
elif stddev_p == 5:
    outputDir = Path.cwd() / "wt_pos_stddev_5"
else:
...
if stddev_t == 0:
    ...
    outputDir = Path.cwd() / "wt_time_stddev_1"
elif stddev_t == 2:
    outputDir = Path.cwd() / "wt_time_stddev_2"
elif stddev_t == 3:
    outputDir = Path.cwd() / "wt_time_stddev_3"
else:
