...
trackstates_wot.Draw("res_eLOC1_ubs>>hist_DUT_Res_wot(150, -0.2, 0.2)", "layer_id==8 && nMeasurements>=4")
...
trackstates_wt.Draw("res_eLOC1_ubs>>hist_DUT_Res_wt(150, -0.2, 0.2)", "layer_id==8 && nMeasurements>=4")
