...
file_path = "/home/ZhangHaolin/ACTS/acts/RunSpace/wt_time_stddev_2/trackstates_ckf.root"
file = ROOT.TFile.Open(file_path, "READ")

c1 = ROOT.TCanvas("c1", "Canvas for DUT Resolution loc1", 800, 600)

trackstates= file.Get("trackstates")
trackstates.Draw("res_eLOC1_smt>>hist_DUT_Res(150, -0.5, 0.5)", "layer_id==8")

hist_DUT_Res = ROOT.gDirectory.Get("hist_DUT_Res")
hist_DUT_Res.SetTitle("DUT Resolution-loc1 with Time")

if hist_DUT_Res:

    gaussFit = ROOT.TF1("gaussFit", "gaus", -0.5, 0.5)
    gaussFit.SetParLimits(0, 4000, 8000)
    ...
    c1.Update()
    c1.SaveAs("DUT-Res-eLOC1-wt.pdf")
    c1.SaveAs("DUT-Res-eLOC1-wt.png")
