...
for i, (x, y) in enumerate(zip(nmea_range, te_1_wot)):
...
graph1.SetTitle("Tracking Efficiency Compare about numMeasurementsCut")
...
for i, (x, y) in enumerate(zip(nmea_range, te_15_wot)):
...
for i, (x, y) in enumerate(zip(nmea_range, te_1_wt)):
...
graph3.SetTitle("Tracking Efficiency Compare about numMeasurementsCut")
...
for i, (x, y) in enumerate(zip(nmea_range, te_15_wt)):
...
# Title
canvas.SetTitle("Tracking Efficiency Compare about numMeasurementsCut")
canvas.SaveAs("TE-nMea-4.pdf")
#canvas.SaveAs("TE-nMea-4.png")
