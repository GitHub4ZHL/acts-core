...
file_paths_1 = [f"{base_path}wot_1_chi2_{chi2}/performance_ckf.root" for chi2 in chi2_range]
file_paths_15 = [f"{base_path}wot_15_chi2_{chi2}/performance_ckf.root" for chi2 in chi2_range]
...
canvas.SaveAs("TE-Chi2-WoT.pdf")
canvas.SaveAs("TE-Chi2-WoT.png")
