...
for file_path in file_paths_1_wot:
    ...
    #print(value)
    drerr_1_wot = (tefficiency.GetEfficiencyErrorLow(3)+tefficiency.GetEfficiencyErrorUp(3))/2
    dr_1_wot.append(value)
    DRErr_1_wot.append(drerr_1_wot)
    file.Close()
...
for i, (x, y) in enumerate(zip(nmea_range, dr_1_wot)):
    graph1.SetPoint(i, x, y)
for i, (e) in enumerate(zip(DRErr_1_wot)):
    graph1.SetPointError(i, 0, DRErr_1_wot[i-1])
...
graph1.SetTitle("Duplicated Rate Compare about numMeasurementsCut")
...
for file_path in file_paths_15_wot:
    ...
    value = tefficiency.GetEfficiency(3)
    #print(value)
    drerr_15_wot = (tefficiency.GetEfficiencyErrorLow(3)+tefficiency.GetEfficiencyErrorUp(3))/2
    dr_15_wot.append(value)
    DRErr_15_wot.append(drerr_15_wot)
    file.Close()
n_points = len(nmea_range)

graph2 = ROOT.TGraphErrors(n_points)

for i, (x, y) in enumerate(zip(nmea_range, dr_15_wot)):
    graph2.SetPoint(i, x, y)
for i, (e) in enumerate(zip(DRErr_15_wot)):
    graph2.SetPointError(i, 0, DRErr_15_wot[i-1])
...
graph2.GetYaxis().SetRangeUser(0, 0.2)
...
for file_path in file_paths_1_wt:
    ...
    value = tefficiency.GetEfficiency(3)
    #print(value)
    drerr_1_wt = (tefficiency.GetEfficiencyErrorLow(3)+tefficiency.GetEfficiencyErrorUp(3))/2
    dr_1_wt.append(value)
    DRErr_1_wt.append(drerr_1_wt)
    file.Close()
...
for i, (x, y) in enumerate(zip(nmea_range, dr_1_wt)):
    graph3.SetPoint(i, x, y)
for i, (e) in enumerate(zip(DRErr_1_wt)):
    graph3.SetPointError(i, 0, DRErr_1_wt[i-1])
...
graph3.GetYaxis().SetRangeUser(0, 0.2)
graph3.SetLineStyle(1)
graph3.SetLineColor(ROOT.kGreen)
graph3.SetTitle("Duplicated Rate Compare about numMeasurementsCut")
...
for file_path in file_paths_15_wt:
    ...
    value = tefficiency.GetEfficiency(3)
    #print(value)
    drerr_15_wt = (tefficiency.GetEfficiencyErrorLow(3)+tefficiency.GetEfficiencyErrorUp(3))/2
    dr_15_wt.append(value)
    DRErr_15_wt.append(drerr_15_wt)
    file.Close()
n_points = len(nmea_range)

graph4 = ROOT.TGraphErrors(n_points)

for i, (x, y) in enumerate(zip(nmea_range, dr_15_wt)):
    graph4.SetPoint(i, x, y)
for i, (e) in enumerate(zip(DRErr_15_wt)):
    graph4.SetPointError(i, 0, DRErr_15_wt[i-1])
...
graph4.GetYaxis().SetRangeUser(0, 0.2)
...
# Title
canvas.SetTitle("Duplicated Rate Compare about numMeasurementsCut")
canvas.SaveAs("DR-nMea-4.pdf")
#canvas.SaveAs("DR-nMea-4.png")
