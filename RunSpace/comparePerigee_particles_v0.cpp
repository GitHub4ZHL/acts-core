...
//ana_momentum_scan, try to fit with just gaus

void comparePerigee_particles_v0(
  ...
  for(const auto& [deg, hists] : widths0){
    ...
    hists[1]->GetYaxis()->SetRangeUser(0., 1.2); 
...
//////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  for(const auto& [deg, hists] : widths0){
    ...
    if(usePt){ 
      hists[6]->GetYaxis()->SetRangeUser(0.2, 2);
    } else {
